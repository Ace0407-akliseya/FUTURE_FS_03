        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="order-1 lg:order-2 space-y-12">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-display font-bold text-foreground mb-6">Connect with Simoo Excellence</h2>
              <p className="text-muted-foreground text-lg">
                Planning a gathering at our lounge or have a question about our signature blends? Fill out the form below or browse our most common questions.
              </p>
            </div>

            <div className="space-y-6">
              {[
                { q: "Do you take reservations?", a: "We primarily welcome walk-ins but accept bookings for large groups and special events." },
                { q: "Do you have vegan options?", a: "Yes! We offer a full range of plant-based milks and a curated selection of vegan pastries." },
                { q: "Is there Wi-Fi?", a: "Absolutely. We provide complimentary high-speed Wi-Fi for all our guests" },
                { q: "Where can I park?", a: "We offer free on-site parking to make your visit to Dire Dawa completely stress-free." },              ].map((faq, i) => (
